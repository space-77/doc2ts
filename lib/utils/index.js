...
exports.ts2Js = exports.getTsFiles = exports.traverseDir = exports.checkJsLang = exports.judgeIsVaildUrl = exports.getModelUrl = exports.format = exports.createFile = exports.resolveOutPath = exports.rename = exports.getConfig = exports.loadPrettierConfig = exports.findDiffPath = exports.firstToLower = exports.firstToUpper = exports.camel2Kebab = void 0;
...
function ts2Js(filesInfo, declaration) {
    const getFilePath = (fileName) => {
        var _a;
        return (_a = filesInfo.find(i => new RegExp(i.fileName).test(fileName))) === null || _a === void 0 ? void 0 : _a.filePath;
    };
    const options = {
    ...
    host.writeFile = (fileName, contents) => {
        ...
        if (fileName.endsWith(jsType)) {
            ...
            return;
        fs_1.default.writeFileSync(filePath, contents, 'utf-8');
    };
    ...
    const program = typescript_1.default.createProgram(filesName, options, host);
    program.emit();
}
exports.ts2Js = ts2Js;
