...
exports.getName = exports.ts2Js = exports.getTsFiles = exports.traverseDir = exports.checkJsLang = exports.judgeIsVaildUrl = exports.format = exports.createFile = exports.resolveOutPath = exports.rename = exports.getConfig = exports.loadPrettierConfig = exports.getRootFilePath = exports.findDiffPath = exports.firstToLower = exports.firstToUpper = exports.camel2Kebab = void 0;
...
function ts2Js(filesNames, declaration, cb) {
    const options = {
...
function getName(name) {
    return config_1.keyWordsListSet.has(name) ? `${name}_` : name;
}
