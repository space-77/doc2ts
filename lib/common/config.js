...
exports.tempNameList = exports.tsObjType = exports.keyWords = exports.keyWordsListSet = exports.Config = exports.PrettierConfig = exports.PARAMS_NAME = exports.Surrounding = exports.CONFIG_PATH = void 0;
...
class Config {
    ...
    constructor(config) {
        ...
        this.clearOutDir = true; // 生成文件前，清空文件输出文件夹
        this.disableParams = []; // 文件输出地址
...
exports.tsObjType = new Set(['Array', '[]', 'object', '{}', 'Date', 'number', 'string', 'boolean', 'ObjectMap']);
// 泛型代表字母
exports.tempNameList = ['T', 'E', 'K', 'V', 'U', 'A', 'B', 'C', 'F', 'G', 'H', 'I', 'J'];
