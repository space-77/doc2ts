...
class Doc2Ts {
    ...
    initRemoteDataSource() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //   log.info(text)
            // })
            fs_1.default.writeFileSync(path_1.default.join(__dirname, `../../mock/modelInfoList.json`), JSON.stringify(this.StandardDataSourceList));
        });
    }
    generateFileData() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dataList = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../mock/modelInfoList.json')).toString();
            ...
            const { render, outDir, hideMethod, prettierPath, baseClassName, baseClassPath, typeFileRender, methodConfig, resultTypeRender,
            // moduleConfig = {}
             } = this.config;
