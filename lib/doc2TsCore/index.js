...
class Doc2Ts {
    ...
    createFiles() {
        ...
        if (clearOutDir) {
            const outDirPath = path_1.default.join((0, utils_1.resolveOutPath)(outDir));
            ...
            const removeFiles = [
                path_1.default.join(outDirPath, 'index.d.ts'),
                path_1.default.join(outDirPath, 'index.ts'),
                path_1.default.join(outDirPath, 'index.js')
            ];
