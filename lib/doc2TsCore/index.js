    ...
    transform2js() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                filesInfo.push({ fileName: '__modelIndexFile__', filePath: path_1.default.join(outDirPath, 'index.ts') });
                (0, utils_1.ts2Js)(filesInfo, declaration);
                if (!emitTs) {
                    filesInfo.forEach(({ filePath }) => {
                        if (fs_1.default.existsSync(filePath))
                            fs_1.default.unlinkSync(filePath); // 删除源ts文件
                    });
                }
