...
class Manage {
    ...
    loadConfig() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.noVerify = (_a = gitConfig === null || gitConfig === void 0 ? void 0 : gitConfig.noVerify) !== null && _a !== void 0 ? _a : true;
            // this.commitId = gitConfig?.commitId
            this.docBranchname = (_b = gitConfig === null || gitConfig === void 0 ? void 0 : gitConfig.branchname) !== null && _b !== void 0 ? _b : config_2.GIT_BRANCHNAME;
            // console.log(config.outDir)
            // 复制 切换分支前的 doc2ts-config.ts 文件内容到 内存
            this.doc2tsConfigContent = fs_extra_1.default.readFileSync((0, index_2.getRootFilePath)(config_1.CONFIG_PATH)); // .toString()
        });
    }
    // 切换至源来分支
    checkout2Base() {
    ...
    checkout2Doc() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield (0, utils_1.hasFileChange)(`${outDir}/*`)) {
                log_1.default.error(`${log_1.default.errTag(' error ')} ${log_1.default.link(`${outDir}`)} ${log_1.default.errColor('目录下有文件没提交，请处理后在重新，本次操作将取消.')}`);
                process.exit(0);
            }
            ...
            if (err)
                throw new Error(stderr);
            fs_extra_1.default.writeFileSync((0, index_2.getRootFilePath)(config_1.CONFIG_PATH), this.doc2tsConfigContent);
        });
    }
    getBranch() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    initBranchname() {
        return __awaiter(this, void 0, void 0, function* () {
            const { outDir } = this.config;
            const commitId = yield (0, utils_1.getFirstCommitId)(`${outDir}/index.ts`);
            const [err, stdout, stderr] = yield (0, utils_1.createBranchname)(this.docBranchname, commitId);
            if (err)
                throw new Error(stderr);
        });
    }
    checkStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, utils_1.hasFileChange)(this.includeFiles);
        });
    }
    addFile() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    commitFile() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [err, stdout, stderr] = yield (0, utils_1.gitCommit)(exec);
            if (err)
                throw new Error(stderr);
            return stdout;
        });
    ...
    mergeCode() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (messagekey_1.mergeConflict.test(stdout)) {
                log_1.default.log(log_1.default.warning('=== 合并冲突，请手动处理 ==='));
                log_1.default.log(log_1.default.warning('=== 合并冲突，请手动处理 ==='));
                log_1.default.log(log_1.default.warning('=== 合并冲突，请手动处理 ==='));
            }
            else if (err) {
