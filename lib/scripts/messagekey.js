...
exports.mergeConflict = exports.notCommitId = exports.ignoredFile = exports.replacedLF = exports.notBranch = exports.nothingCommit = exports.noChanges = exports.notGit = void 0;
// 不是 git 管理的仓库
exports.notGit = /not\s+a\s+git\s+repository/i;
// 没有代码提交
exports.noChanges = /no\s+changes\s+added\s+to\s+commit/i;
// 没有代码commit
exports.nothingCommit = /(nothing\s+to\s+commit)|(nothing\s+added\s+to\s+commit)/i;
// 没有代码commit
...
// merge 合并冲突
exports.mergeConflict = /conflict/i;
