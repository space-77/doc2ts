...
class TypesList {
                ...
                const _value = Object.entries(properties).map(([keyName, info]) => {
                    ...
                    if (originalRef) {
                        const params = {
                            ...
                            preRef: originalRef,
                            typeName: (0, utils_1.firstToUpper)(keyName)
                        };
    ...
    formarModelData() {
        ...
        const apiInfos = Object.entries(paths).map(([url, value]) => {
            ...
            // 返回体相关
            const { originalRef } = (_b = responses[200].schema) !== null && _b !== void 0 ? _b : {};
            ...
            if (itemTypeInfo && this.dataKey)
                this.advanceType(itemTypeInfo);
