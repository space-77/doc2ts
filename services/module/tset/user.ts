...
createUser: mT.CreateUser = body => {
  const url = '/user'
  const config = { '/user',body: body, method: 'post' }
...
loginUser: mT.LoginUser = params => {
  ...
  const config = { `/user/login?${this.serialize({params})}`, method: 'get' }
  return this.request(config)
}
...
logoutUser: mT.LogoutUser = () => {
  ...
  const config = { '/user/logout', method: 'get' }
  return this.request(config)
}
...
getUserByName: mT.GetUserByName = username => {
  ...
  const config = { `/user/${username}`, method: 'get' }
  return this.request(config)
}
...
const body = {body:_body}
  const url = `/user/${username}`
  const config = { `/user/${username}`, body, method: 'put' }
  return this.request(config)
}
...
deleteUser: mT.DeleteUser = username => {
  const url = `/user/${username}`
  const config = { `/user/${username}`, method: 'delete' }
  return this.request(config)
}
...
createUsersWithListInput: mT.CreateUsersWithListInput = body => {
  ...
  const config = { '/user/createWithList',body: body, method: 'post' }
  return this.request(config)
}
...
createUsersWithArrayInput: mT.CreateUsersWithArrayInput = body => {
  ...
  const config = { '/user/createWithArray',body: body, method: 'post' }
  return this.request(config)
}
}
